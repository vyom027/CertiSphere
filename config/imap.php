...
return [
    ...
    'connections' => [
        'default' => [
            'host'          => env('IMAP_HOST', 'mail.ljku.edu.in'),
            'port'          => env('IMAP_PORT', 993),
            'encryption'    => env('IMAP_ENCRYPTION', 'ssl'),
            'validate_cert' => env('IMAP_VALIDATE_CERT', false), // Test with false
            'username'      => env('IMAP_USERNAME', '23004500210215@mail.ljku.edu.in'),
            'password'      => env('IMAP_PASSWORD', 'your_password_here'),
    ...
    */
    'accounts' => [
        ...
        'default' => [// account identifier
            ...
            'encryption'    => 'ssl',
            'validate_cert' => true,
            'username'      => '', // Will set dynamically
            'password'      => '', // Will set dynamically
            'protocol'      => 'imap'
        ],
