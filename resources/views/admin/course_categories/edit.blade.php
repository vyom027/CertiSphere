              ...
              <div class="col-md-8 mx-auto">
                  <div class="card">
                      <div class="card-header d-flex justify-content-between align-items-center">
                          ...
                          <a href="{{ route('admin.course_categories.index') }}" class="btn btn-secondary btn-sm">Back</a>
                      </div>
                      <div class="card-body">
                          <form action="{{ route('admin.course_categories.update', $category->id) }}" method="POST">
                              @csrf
                              @method('PUT')
                              ...
                              <div class="mb-3">
                                  <label for="link" class="form-label">Category Link</label>
                                  <input type="url" class="form-control" id="link" name="link" value="{{ old('link', $category->link) }}" placeholder="https://example.com" maxlength="255">
                              </div>
