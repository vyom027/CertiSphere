                  ...
                  <table class="table align-items-center mb-0">
                    <thead>
                      <tr>
                        ...
                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Starting Year</th>
                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Ending Year</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                            <p class="text-s font-weight-bold mb-0">{{ $batch->department->name ?? 'No Department Assigned' }}</p>

                        </td>
                        <td class="align-middle text-center text-sm">
                            <p class="text-s font-weight-bold mb-0">{{ $batch->start_year }}</p> 
                        </td>

                        <td class="align-middle text-center text-sm">
                            <p class="text-s font-weight-bold mb-0">{{ $batch->end_year }}</p> 
                        </td>
                        <td class="align-middle text-center">
                          <a href="{{ route('batch.edit', ['id' => $batch->batch_id]) }}" class="btn btn-primary btn-sm">Edit</a>
                          <form action="{{ route('batch.destroy', ['id' => $batch->batch_id]) }}" method="POST" style="display:inline;">
                              @csrf
                              @method('DELETE')
