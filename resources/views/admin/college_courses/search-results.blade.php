        ...
        @foreach ($courses as $course)
          <li class="list-group-item d-flex justify-content-between align-items-center">
            <div>
              ...
              <a href="https://www.coursera.org/learn/{{ $course['slug'] }}" target="_blank">Preview</a>
            </div>
            <a href="{{ route('admin.college-courses.create', ['name' => $course['name'], 'link' => 'https://www.coursera.org/learn/' . $course['slug']]) }}"
